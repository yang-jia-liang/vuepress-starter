...
module.exports = {
    ...
    // 以下代码是我看其他人的vuepress项目 复制 -> 翻译 出来的，基本可以忽略
    head: [
        ["link", { rel: "icon", href: "/images/favicon.png" }],                           // 浏览器tab页的小图标
    ...
    themeConfig: {
         ...
         * 如果你需要全文搜索，你可以使用 Algolia 搜索
         ...
         searchMaxSuggestions: 3, // 显示的搜索结果数
         * */
         ...
         *
         ...
         repo: "https://github.com/yang-jia-liang/vuepress-starter", // 完整的 GitHub || GitLab URL
